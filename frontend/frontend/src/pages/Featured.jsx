...
function Featured() {
  ...
  return (
    <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">Featured Departments</h1>
        ...
        {departments.length > 0 ? (
          departments.map((department) => (
            <div key={department.id} className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-4">
              <h1 className="text-md font-semibold text-gray-800">Some of the Courses Offered:</h1>
